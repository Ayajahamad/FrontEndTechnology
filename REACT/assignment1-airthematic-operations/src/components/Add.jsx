  ...
  return (
    <div className="container">
        <div className="row d-flex justify-content-center text-center">
            ...
            <button className="btn bg-success text-white my-3 mx-2" onClick={Add}>Addition</button>
            <button className="btn bg-success text-white my-3 mx-2" onClick={Sub}>Substraction</button>
            <button className="btn bg-success text-white my-3 mx-2" onClick={Mul}>Multiplication</button>
            <button className="btn bg-success text-white my-3 mx-2" onClick={Div}>Division</button>
