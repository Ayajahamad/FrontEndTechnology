  ...
  if (!products) {
      ...
      <div className="container">
        <div className="row">
          <div className="col text-center">
            <h3 className="display-3 text-secondary">Products.. Server Error</h3>
          </div>
        </div>
      </div>
    )
    ...
    return(
      <div className="container">
                    ...
                    <div className="card-body">
                      ...
                      <ul className="list-group">
                        <li className="list-group-item">
                          <strong>Price</strong>
                          <span className="float-end text-success">&#8377 {item.price}</span>
                        </li>
                      </ul>
                    </div>
                  </div>
       ...
       <div className="row">
       <div className="col-xs-12 col-sm-12 offset-md-3 col-md-6 offset-lg-3 col-lg-6 offset-xl-3 col-xl-6 offset-xxl-3 col-xxl-6 my-3">
          <ReactPaginate
            pageCount={pageCount}
